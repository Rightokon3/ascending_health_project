...
$sql = "SELECT * FROM mental_post WHERE id = ?";
...
<body>
    ...
    <div class="container">
        ...
        <div id="myDropdown" class="dropdown-content">
            <a href="#"><i class="fa fa-facebook" style="color:green;"></i></a>
            <a href="#"><i class="fa fa-linkedin"  style="color:green;"></i></a>
            <a href="#"><i class="fa fa-twitter"  style="color:green;"></i></a>
            <a href="#"><i class="fa fa-whatsapp"  style="color:green;"></i></a>
            <a href="#"><i class="fa fa-instagram"  style="color:green;"></i></a>
        </div>
            <i class="fa fa-bars" id="menu-icon" onclick="menutoggle()" style="font-size: 20px; font-weight: 600;color:white;"></i>
        </div>
        <div class="row">
            <div class="col-2">
          <center>  <h1 style="color:lightgreen;font-size:69px"><small></small><i>Ascending <span style="color:black;">Mental</span>Artice</i></h1></center>
            </div>
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<img src='" . $row['Image'] . "' alt='Uploaded Image' class='article-image'>";
