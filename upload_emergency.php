...
if (isset($_POST["title"])) { 
  require "db_emergency.php";
   echo "<script>alert('successfully added');document.location.href='display_emergency';</script>  ";
  echo $result == "" 
...
?>
        ...
        <label for="content3" style="color:black;">first aids tips:</label>
        <textarea id="content3" name="tips" cols="30" rows="10"></textarea>
        <label for="conculsion" style="color:black;"></label>
        <textarea id="conculsion" name="conculsion" cols="30" rows="10"></textarea>
