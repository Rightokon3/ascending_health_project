...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-2">
          <center>  <h1 style="color:white;font-size:69px"><small></small><i>Ascending <span style="color:black;">Mental health</span>Artice</i></h1></center>
            </div>
 ...
 <div class="team">
    <center>
        <h3>enjoy our Mental article concerning the mental health </h3>
    </center>
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<p><a href='article_mental?id=".$row['id']."'>Learn more</a><p>";
