...
<body>
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="cardBox">
                <div class="card">
                    <a href="upload_team" style="text-decoration:none;">
                    <div>
                        <div class="cardName">Add to the team</div>
                    </a>
                    </div>
                ...
                <div class="card">
                    <a href="display_team" style="text-decoration:none;">
                    <div>
                        <div class="numbers"><p id="count"><?php echo $row['count'];?></p></div>
